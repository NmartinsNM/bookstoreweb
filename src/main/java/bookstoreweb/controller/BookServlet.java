...
import bookstoreweb.model.dao.BookDAO;
...
public class BookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Logger.getLogger(BookServlet.class.getName()).log(Level.INFO, "Path solicitados: {0}", action);
    ...
    private void listBook(HttpServletRequest request, HttpServletResponse response)
        ...
        Logger.getLogger(BookDAO.class.getName()).log(Level.INFO, "Total de registros: {0}", listaBook.size());
        
        request.setAttribute("listaBookNat", listaBook);
